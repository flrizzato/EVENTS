...
type
  ...
  public
    { Public declarations }
    function SendEmailAPI(aTenant, aUser_id, aClient_id, aClient_secret
      : string): boolean;
  end;
...
function TMainDM.SendEmailAPI(aTenant, aUser_id, aClient_id, aClient_secret
  : string): boolean;
var
